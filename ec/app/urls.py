...
from .forms import LoginForm, MyPasswordResetForm, MyPasswordChangeForm, MyPasswordResetForm
...
urlpatterns = [
    ...
    path('order/placed/', order_placed, name='order_placed'),    path('cart/', views.show_cart, name='showcart'),
